...
import { Loader2, LogOut, Map as MapIcon, User, UserCircle, Waypoints } from 'lucide-react'
...
export default function CoastGuardAccount() {
        ...
        <main className="flex-1 overflow-hidden">
          <div className="flex h-full flex-col">
            ...
            <div className="flex-1 p-6">
              ...
              {!loading && profile && (
                <Card className="max-w-xl border-white/5 bg-slate-900/80">
                  <CardHeader>
              ...
              {!loading && !profile && <p className="text-sm text-red-300">Unable to load account information.</p>}

              <Card className="mt-4 max-w-xl border-white/5 bg-slate-900/80">
                <CardHeader>
